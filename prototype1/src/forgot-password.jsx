                ...
                <div className="reset-password-form mx-8">
                    ...
                    <form className="mb-5 flex flex-col gap-4 items-center" action="/login" method="POST">
                        <div className="relative placeholder-black">
                            <input className="p-4 text-black font-bold border-3 border-gray-500 border-solid rounded-2xl w-auto bg-[#ffffff1a] dark:text-white dark:border-[#ffffff1a] focus:border-[#2be295] focus:outline-none user-invalid:border-[#ffad00]" type="email" name="email" id="email" placeholder="E-mail*" required />
                        </div>
