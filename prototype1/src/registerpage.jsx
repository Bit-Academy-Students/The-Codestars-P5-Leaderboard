    ...
    return (
        <div className="card m-auto p-12 rounded-[2.5rem] bg-[#f0e8d8b3] min-w-fit max-w-fit absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 dark:bg-[rgba(10, 21, 26, 0.7)]">
            <div className="login-form mx-8">
                <p className="text-3xl font-bold mb-10">Register</p>

                <form className="mb-5 flex flex-col gap-4 items-center" action="/register" method="POST">
                    <div className="relative placeholder-black">
                        <input className="p-4 text-black border-2 border-black border-solid rounded-2xl w-108 bg-[#64646433]" type="text" name="username" id="username" placeholder="Username*" required />
                    </div>
